...
mkdir -p "$TMP/.grill-adapter/wiki/frontend"
cat > "$TMP/.grill-adapter/wiki/frontend/hook-guidelines.md" << 'WIKI'
# Hook Guidelines
...
cat > "$TMP/.grill-adapter/wiki/frontend/hook-guidelines.index.md" << 'WIKI'
# Hook Guidelines
...
cat > "$TMP/.grill-adapter/wiki/frontend/type-safety.md" << 'WIKI'
# Type Safety
...
cat > "$TMP/.grill-adapter/wiki/frontend/type-safety.index.md" << 'WIKI'
# Type Safety
...
cat > "$TMP/.grill-adapter/wiki/frontend/with-code-block.md" << 'WIKI'
# Code Block Test
...
cat > "$TMP/.grill-adapter/wiki/frontend/broken.md" << 'WIKI'
# Broken Markers
...
" "$TMP/.grill-adapter/wiki/frontend/broken.md")
...
" "$TMP/.grill-adapter/wiki/frontend/hook-guidelines.md")
...
cat > "$TMP/.grill-adapter/wiki/frontend/summaries.md" <<'WIKI'
# Summaries
...
" "$TMP/.grill-adapter/wiki/frontend/summaries.md")
...
cat > "$TMP/.grill-adapter/wiki/frontend/bad-summary.md" <<'WIKI'
# Bad
...
" "$TMP/.grill-adapter/wiki/frontend/bad-summary.md")
