...
if [[ -f "${TARGET_INPUT}/agents/lanhu-frontend-html-requirements-analyst.md" ]] && grep -Fq 'Generated by grill-adapter' "${TARGET_INPUT}/agents/lanhu-frontend-html-requirements-analyst.md"; then
