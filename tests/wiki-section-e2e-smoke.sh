...
cat > "$TMP/.grill-adapter/wiki/index.md" << 'WIKI'
# Project Wiki

- [Frontend](frontend/)
WIKI

cat > "$TMP/.grill-adapter/wiki/frontend/index.md" << 'WIKI'
# Frontend
...
INDEX="$TMP/.grill-adapter/wiki/frontend/hook-guidelines.index.md"
