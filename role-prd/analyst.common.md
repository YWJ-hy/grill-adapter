...
This file is generated from `role-prd/analyst.common.md` and {{ROLE_PRD_SOURCE_PATHS}}. Edit those sources, then run `python3 lib/sync_role_prd.py sync`.
...
<!-- grill-adapter:role-prd-template:start role={{ROLE}} packageKind={{OUTPUT_FORMAT}} -->
...
<!-- grill-adapter:role-prd-template:end role={{ROLE}} packageKind={{OUTPUT_FORMAT}} -->
