...
When refreshing mechanical state (step 11), if the shared update went through the GitHub-backed MCP PR flow, use the MCP validation summary instead of refreshing local `.shared-adapter/wiki/`.
