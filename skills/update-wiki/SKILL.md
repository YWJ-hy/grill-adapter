...
When you learn something valuable from implementation, debugging, review, or discussion, use this skill to decide whether the relevant wiki pages under `.adapter/wiki/` or `.shared-adapter/wiki/` need updates.
