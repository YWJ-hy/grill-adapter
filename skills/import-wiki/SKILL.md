...
Use this skill when the user provides an existing wiki page or directory that should be copied into this adapter's `.superpowers/wiki` or `.shared-superpowers/wiki` tree.
