...
Use this skill to help the user initialize `.adapter/wiki/` and/or `.shared-adapter/wiki/` from the current project state.
...
2. Ensure at least one wiki index exists: `.adapter/wiki/index.md` or `.shared-adapter/wiki/index.md`; if neither exists, ask the user to run `bootstrap-wiki` first with `--wiki-root project` or `--wiki-root shared`.
