...
This is the host-agnostic **Bind** touchpoint for schema-v5 section sidecars and schema-v6 Obsidian sidecars. During implementation or review it rereads, for the current ticket, the authoritative full text of every routed hard constraint. Schema-v6 rereads use only stable IDs and paths through the bound Obsidian MCP; sidecar metadata summaries never substitute for the runtime Note text.
