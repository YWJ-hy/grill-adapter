---
name: wiki-readiness
description: Establish one stable task identity, freeze or reuse role-specific Wiki task contracts before code changes, and prepare a shared fail-open reviewer handoff before code review.
---
