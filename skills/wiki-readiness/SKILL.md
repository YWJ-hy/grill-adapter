---
name: wiki-readiness
description: Establish one stable implementation task identity, reuse or perform Wiki Carry, bind implementer constraints, and record an atomic fail-open readiness result before code changes.
---
