---
name: migrate-wiki
description: "Migrate legacy Wiki structure, enrich its section graph, or plan/apply/verify/cut over a bound Obsidian migration. Use only when explicitly invoked or the project is wired/configured for grill-adapter; do not auto-use in a standalone grill workflow."
---
