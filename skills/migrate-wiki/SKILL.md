...
Use this skill to migrate existing `.adapter/wiki/` documents, or a user-provided legacy GitHub shared-wiki repository, to the two-layer index structure and bound Obsidian Sources.
