---
name: wiki-research
description: Disclose relevant project/shared wiki context by driving the wiki-researcher agent, and at planning or implementation-entry readiness time turn its selection into a finalized .wiki-context.json sidecar. Host-agnostic Disclose+Carry entry for grill, plain Claude Code, or Codex.
---
