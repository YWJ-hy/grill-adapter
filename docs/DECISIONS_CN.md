...
- source/target snapshot digest 绑定审计输入。semantic split、duplicate ID、dangling edge、unavailable pack、Shared neutrality violation 与 non-migratable navigation 必须进入 confirmation gate，不由 planner 猜测修复。
